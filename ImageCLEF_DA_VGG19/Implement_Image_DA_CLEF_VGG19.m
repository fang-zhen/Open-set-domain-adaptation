...
srcStrVGG19 = {'b', 'b', 'b', 'i', 'i', 'i', 'c',  'c', 'c', 'p', 'p', 'p'};
tgtStrVGG19 = {'c', 'i', 'p', 'b', 'c', 'p', 'b',  'i', 'p', 'b',  'c', 'i'};
datafeature = 'VGG19';
...
for iData = 1:12
    ...
    if strcmp(datafeature,'VGG19')
        ...
        load(['C:\Users\Fangzhen\Desktop\新建文件夹\DAOD  code\ImageCLEF_DA_VGG19\ImageDA_CLEF_VGG19\' src '.mat']);
        Xs = double(fea); 
        Ys = double(labels');
        Zs=[Xs,Ys];
        ...
        load(['C:\Users\Fangzhen\Desktop\新建文件夹\DAOD  code\ImageCLEF_DA_VGG19\ImageDA_CLEF_VGG19\' tgt '.mat']);
        Xt = double(fea); 
        Yt = double(labels');
        Zt=[Xt,Yt];
