...
srcStrVGG16 = {'Ar',   'Ar',  'Ar',  'Cl', 'Cl', 'Cl', 'Pr',  'Pr',  'Pr',  'Rw',  'Rw',  'Rw'};
tgtStrVGG16 = {'Cl',   'Pr',  'Rw',  'Ar', 'Pr', 'Rw', 'Ar',  'Cl',  'Rw',  'Ar',  'Pr',  'Cl'};
...
for iData = 1:12
    ...
    if strcmp(datafeature,'VGG16')
        ...
        load(['C:\Users\Fangzhen\Desktop\新建文件夹\DAOD\Office_Home_VGG16\Office-Home\' src '.mat']);
        Xs = double((fea)); 
        Ys = double(labels');
        Zs=[Xs,Ys];
        ...
        load(['C:\Users\Fangzhen\Desktop\新建文件夹\DAOD\Office_Home_VGG16\Office-Home\' tgt '.mat']);
        Xt = double((fea)); 
        Yt = double(labels')+1;
        Zt=[Xt,Yt];
